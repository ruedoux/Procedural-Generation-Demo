...
@onready
var noiseSeed: LineEdit = $C/H/OptionPanel/B/P/V/S/V/NoiseContainer/Container/Noise/V/Seed/LineEdit

@onready
var TileContainer: VBoxContainer = $C/H/OptionPanel/B/P/V/S/V/TilesContainer/Container/Tiles/V/TileContainer
